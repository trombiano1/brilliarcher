function theScript() {
	...
	tempString = theOriginalString.toLowerCase();
	if (theOriginalString !== null && theOriginalString !== "" && theOriginalString.toLowerCase() != "show examples") {
		...
		for (outerCount = 0; outerCount < theDividedString.length; outerCount++) {
			for (count = 0; count < theLanguageList.length; count++) {
				if (theDividedString[outerCount] == theLanguageList[count] && theDividedString[outerCount - 1] == "in") {
					theQuestionType = "S";
					theLibNumber = 0;
		...
		for (count = 0; count < theDividedString.length; count++) {
			if (theLibNumber == -1 && theDividedString[count] == "on" && theDividedString[count+1] == "this" && theDividedString[count+2] == "site") {
